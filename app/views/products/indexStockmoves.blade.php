...
<div class="col-md-12" style="margin-top: 20px">
	<h4 style="margin-top: 40px">Products :: {{ $product->name }} [All Stock Movements]</h4>
...
@else
	<div class="alert alert-info col-md-2" style="margin-top: 15px;"><strong>No Stock Movements</strong> for this Product.</div>
@endif
